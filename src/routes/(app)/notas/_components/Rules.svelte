...
<div
	class="bg-base-100 rounded-lg border border-base-400 shadow-sm {selectedRamoId ? '' : 'hidden'}"
>
	<button
		onclick={openModal}
	...
	{#if modalOpen}
		<div class="fixed inset-0 z-50 flex items-center justify-center">
			...
			<div
				class="relative w-full max-w-md bg-base-100 rounded-2xl shadow-xl border border-base-400 m-4"
			>
				...
				<div
					class="px-6 py-4 border-t border-base-300 flex items-center justify-end gap-2 bg-base-100 rounded-b-2xl"
				>
					<button
						onclick={closeModal}
