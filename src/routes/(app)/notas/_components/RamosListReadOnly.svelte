    ...
    <div class="space-y-3 flex-1 overflow-y-auto min-h-0 pr-1">
        ...
        {:else}
            <div class="text-center py-8 text-content/40">
                ...
                <p class="text-sm mb-4 text-content/60">Agrega ramos desde la página de Ramos para gestionar tus notas</p>
                <a
                    href="/ramos"
                        ...
                        {#each db.ramos.list as [id, ramo] (id)}
                            ...
                            >
                                ...
                                {#if selectedRamoId === id}
                                    <svg class="w-4 h-4 text-grades-100 shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                        <path
                                            fill-rule="evenodd"
