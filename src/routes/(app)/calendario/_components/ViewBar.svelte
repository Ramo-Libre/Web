...
<div class="space-y-4">
	<div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
		<div class="bg-base-100 rounded-xl">
			<div
				class="flex items-center justify-between rounded-xl border border-primary-300 bg-primary-400 px-4 py-3 text-primary-100"
			>
				<div>
		...
		<div class="bg-base-100 rounded-xl">
			...
			>
				<div>
					<div class="text-xs uppercase tracking-wider text-success-100/80 font-bold">
						Completados
					</div>
