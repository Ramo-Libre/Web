...
<div class="bg-white rounded-2xl p-5 border border-slate-200 shadow-sm relative overflow-hidden flex flex-col group">
    ...
    <div class="flex-1 flex flex-col justify-center relative z-10 mt-4">
        ...
        {#if currentClass}
            <div class="flex gap-4 items-stretch">
                <div class="w-1.5 rounded-full shrink-0" style="background-color: {currentClass.color}"></div>
                ...
                <div class="flex-1 min-w-0 flex flex-col justify-center">
                    ...
                    <div class="flex items-center gap-3 text-sm text-slate-500 font-medium mb-3">
                        <span class="flex items-center gap-1 bg-slate-50 border border-slate-100 px-2 py-0.5 rounded-md">
                    ...
                    <div class="flex items-center gap-2">
                        <span class="inline-flex items-center gap-1.5 px-2.5 py-1 text-[11px] font-bold text-green-700 bg-green-100 rounded-lg uppercase tracking-wide">
        ...
        {:else if nextClass}
            <div class="flex gap-4 items-stretch">
                ...
                <div class="flex-1 min-w-0 flex flex-col justify-center">
                    ...
                    <div class="flex items-center gap-2">
                        <span class="inline-flex items-center gap-1.5 px-2.5 py-1 text-[11px] font-bold text-blue-700 bg-blue-50 border border-blue-100 rounded-lg uppercase tracking-wide">
